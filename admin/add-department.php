...
<body>
	...
	<section id="main" class="column">
		...
		<article class="module width_full">
			<header><h3>Department List</h3></header>
...
<form action="insert-Department.php" method="POST">					
					<fieldset>
							...
							<input type="text" name="Ndep" value="" >
						</fieldset>
						<div class="clear"></div>					
...
include('../dbcon.php');
$result1 = "SELECT * FROM Department";
