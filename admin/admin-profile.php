...
$row = mysql_fetch_array($run)
				?>
						<fieldset>
							<label>Name</label>
							<input type="text" value="<?php echo $row['Fname']; ?>" readonly="readonly">
						</fieldset>
						<fieldset>
							<label>Designation</label>
							<input type="text" value="<?php echo $row['Usertype']; ?>" readonly="readonly">
						</fieldset>
					
						<div class="clear"></div>					
				<a href="admin-update.php"><input type="submit" value="EDIT"></a>
