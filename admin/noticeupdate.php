...
$result = "SELECT * FROM Notice WHERE id='$id'";
$run = mysql_query($result) or die("ERROR".mysql_error());
$row=mysql_fetch_array($run);


echo "<form action='setnewmessage.php' method='POST'><textarea name='name' value='".$row['notice']."'></textarea><input type='hidden' name='id' value='". $id ."'></input><input type='submit' value='update'></input></form>";
