	...
	<section id="main" class="column">
		...
		<article class="module width_full">
			...
			<div class="module_content">
				...
				<?php
				$_SESSION['id']=NULL;
					$result1 = "SELECT * FROM project ORDER by date DESC";
$run1 = mysql_query($result1) or die("ERROR".mysql_error());
echo "<table cellspacing='10' cellpadding='25' >";
echo "<tr>";
echo "<th>ID</th>";
echo "<th>Project</th>";
echo "<th>Project Manager</th>";
echo "<th>Duration</th>";
echo "<th>Awarded Date</th>";
echo "<th>Details</th>";
...
while($row1 = mysql_fetch_array($run1))
  ...
  echo "<tr>";	
  echo   "<td>" . $row1['id'] . "</td><td style='height:50: width:200':>" . $row1['projectname'] . "</td><td>". $row1['projectmanager'] ."</td><td>". $row1['duration'] ."</td><td>" . $row1['date'] . "</td><td><form action='projectdetail.php' method='POST'><input type='hidden' name='id' value='". $row1['id'] ."'></input><input type='submit' value='Details'></input></form></td>";
  echo "</tr>";
  ...
  echo "</table>";
	...
	?>		
		...
		<article class="module width_full">
			<header><h3>Award New Project</h3></header>
				<div class="module_content">
				<form action="awardproject.php" method="POST">
						<fieldset>
						...
						<fieldset style="width:48%; float:left; margin-right: 3%;"> <!-- to make two field float next to one another, adjust values accordingly -->
							...
							<select name="name" style="width:92%;">
							<?php 
				$result1 = "SELECT * FROM data WHERE Usertype='Pmanager'";
				$run1 = mysql_query($result1);
				while($row1=mysql_fetch_array($run1)){
				echo "<option value=".$row1['Email'].">".$row1['Fname'] ."&nbsp;".$row1['Lname']."";
				}
				?>
						...
						<fieldset style="width:48%; float:left;"> <!-- to make two field float next to one another, adjust values accordingly -->
							...
							<input type="text" name="dur" style="width:92%;">
						</fieldset><div class="clear"></div>
				</div>
			<footer>
				<div class="submit_link">
					<input type="submit" value="Award" class="alt_btn">
				</div>
			</footer>
			</form>
