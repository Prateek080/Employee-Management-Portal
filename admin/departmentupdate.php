...
<body>
	...
	<section id="main" class="column">
		...
		<article class="module width_full">
			<header><h3>Update Department List</h3></header>
			<div class="module_content">
				...
				<div class="module_content">
<form action="insert-Department.php" method="POST">					
					<fieldset>
...
$result = "SELECT * FROM Department WHERE Id='$id'";
$run = mysql_query($result) or die("ERROR".mysql_error());
$row=mysql_fetch_array($run);


echo "<form action='setnew.php' method='POST'><input type='text' name='name' value='".$row['DepartmentName']."'></input><input type='hidden' name='id' value='". $id ."'></input><input type='submit' value='update'></input></form>";
