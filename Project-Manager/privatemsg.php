...
?>
		...
		<div class="tab_container">
			<div id="tab1" class="tab_content">
				...
				<?php
$user1=$_POST['user'];
$result = "SELECT * FROM conversation WHERE reciever='$user' and sender='$user1'";
...
?>
				...
				<div align='left' >
				<?php 
				$result1 = "SELECT Fname,Lname FROM data WHERE Email='$user1'";
				...
				<font color='#00000' style='margin-left:30px;'><?php echo $row['messag'];?></font>
					<?php }else{?>
				
				<font color='#00000' style='margin-left:30px;'><?php echo $row['messag'];?></font>
				<br><br> <div style='margin-left:-10px;'>FILE:&nbsp;&nbsp;<a href='../upload/<?php echo $row['file'];?>'><?php echo $row['file'];?></a></div>
				<?php } ?>
				</h4>
...
<article class="module width_full">
		...
		<?php }else{}?><!-- end of post new article -->
...
<article class="module width_full">
			...
			<footer>
				<a href='conversation.php'><button>BACK to Previous Page</button></a>
